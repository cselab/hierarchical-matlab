...
function [sys_para] = User_Input_psi_norm()
...
sys_para.save_file = [ data_folder 'HB_norm_psi' ];
...
% sys_para.hard_bds = [  0,   0,   0,   0, -10,  0 ; ...
%                      500, 500, 100, 100,   0, 10 ]; 
sys_para.hard_bds = [  0,    0,  -100,  0,      0,   0,   0,   0; ...
...
for i=1:N
    ...
    sys_para.lik.para.pri{i}   = exp(tmp.out_master.pri(1:Ns_i));
    sys_para.lik.para.lnEv(i)  = tmp.out_master.lnEv;
    sys_para.lik.para.Ns(i)    = sum( tmp.out_master.Ns(1:Ns_i,:) );
end
...
sys_para.pri.name{1} = 'Uniform'; sys_para.pri.para{1} = [100,400];
sys_para.pri.name{2} = 'Uniform'; sys_para.pri.para{2} = [  0,100];
sys_para.pri.name{3} = 'Uniform'; sys_para.pri.para{3} = [-10,10];
sys_para.pri.name{4} = 'Uniform'; sys_para.pri.para{4} = [  0,50];
sys_para.pri.name{5} = 'Uniform'; sys_para.pri.para{5} = [0.0001,50];
sys_para.pri.name{6} = 'Uniform'; sys_para.pri.para{6} = [0.0001,50];
sys_para.pri.name{7} = 'Uniform'; sys_para.pri.para{7} = [0.0001,50];
sys_para.pri.name{8} = 'Uniform'; sys_para.pri.para{8} = [0.0001,50];
