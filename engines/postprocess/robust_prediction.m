...
data_folder = 'data/';
load([data_folder 'IND_theta_' sprintf('%03d',index) '.mat']);
load([data_folder 'data_set_' sprintf('%03d',index) '.mat']);

save_file = [data_folder 'quantiles_' sprintf('%03d',index) '.mat'];
LOAD = false;
